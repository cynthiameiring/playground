<template>
  <section class="max-w-5xl mx-auto my-12 px-4">
    <h1 class="text-3xl lg:text-5xl font-bold text-black mb-10">Step 4 - styling</h1>
    ...
    <div class="flex flex-col md:flex-row mb-10">
      ...
      <div class="flex shrink flex-col justify-between md:ml-8 pt-5 md:pt-0">
        <div class="flex flex-col">
          ...
          <span class="mb-12">Styling van getal aangepast en de startwaarde moet ook 4 kunnen zijn.</span>
        </div>
    ...
    <NuxtLink class="inline-block m-1 px-5 py-3 bg-neutral-100 hover:bg-neutral-200 w-32 text-center" to="/2048/step3"> Vorige</NuxtLink>
    <NuxtLink class="inline-block m-1 px-5 py-3 bg-neutral-100 hover:bg-neutral-200 w-32 text-center" to="/2048/step5"> Volgende</NuxtLink>
  </section>
</template>
